...
<div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-red-200 border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        {{-- start buat tambahan file add dokumen --}}
        <div class="flex items-center justify-center">@include('addfile');</div>
        {{-- end tambah file add dokumen --}}
